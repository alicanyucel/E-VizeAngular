...
@Component({
  selector: "visa-result-exempt-modal",
  templateUrl: "./visa-result-exempt-modal.component.html",
})
export class VisaResultExemptModalComponent implements OnInit, OnDestroy {
