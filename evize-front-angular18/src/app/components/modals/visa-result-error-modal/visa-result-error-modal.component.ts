...
@Component({
  selector: "visa-result-error-modal",
  templateUrl: "./visa-result-error-modal.component.html",
})
export class VisaResultErrorModalComponent implements OnInit, OnDestroy {
