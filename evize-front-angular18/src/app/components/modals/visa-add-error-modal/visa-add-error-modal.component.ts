...
@Component({
  selector: "visa-add-error-modal",
  templateUrl: "./visa-add-error-modal.component.html",
})
export class VisaAddErrorModalComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subscriptions.add(this.languageService.sectionData.subscribe((_: string) => {
      ...
      this.homeSection = this.languageService.getSection("homepage");
    }));
